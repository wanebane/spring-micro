...
public class GlobalErrorException extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ResponseError> handleUsernameAlreadyExists(CustomerAlreadyExistsException ex){
        return ResponseEntity
    ...
    public ResponseEntity<ResponseError> handleUsernameNotFound(CustomerNotFoundException ex){
        return ResponseEntity
